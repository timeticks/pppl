...
public static class AppTimer
{
    ...
    /// 当前时间，毫秒级
    /// </summary>
    public static long CurTimeStampMsSecond { get { return StartTimeStampSecond + (long)TimeUtils.CurrentTimeMillis - StampStartDetla; } }

    public static long StartTimeStampSecond{get;private set;}
    ...
    public static void SetCurStamp(long stampSecond)
    {
        ...
        StampStartDetla = TimeUtils.CurrentTimeMillis;
    }

...
public static class FileBaseUtils
{
    ...
    public const string GameLogicPath = "/Game/4ca7f791f85e1cc7";
    ...
    public static string PersistentReadPath(string url, string filename)
    {
        if (PlatformUtils.EnviormentTy == EnviormentType.Android)
        {
            return Path.Combine(string.Format("{0}/{1}", mPersistentDataPath, url), filename);
        }

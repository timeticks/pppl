...
[AddComponentMenu("UI/Effects/TextLean")]
public class TextLean : BaseMeshEffect
{
    public float _textSpacing = 1f;
    public float _textVerticalSpacing = 1f;
    public override void ModifyMesh(VertexHelper vh)
    {
        ...
        for (int i = 6; i < indexCount; i++)
        {
            ...
            vt = vertexs[i];
            vt.position += new Vector3(_textSpacing * (i / 6), _textVerticalSpacing * (i / 6), 0);
            vertexs[i] = vt;
            //以下注意点与索引的对应关系,  
